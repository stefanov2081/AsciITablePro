...
var AsciiTableRepository = /** @class */ (function () {
    ...
    Object.defineProperty(AsciiTableRepository.prototype, "standartAsciiTable", {
        get: function () {
    ...
    Object.defineProperty(AsciiTableRepository.prototype, "extendedAsciiTable", {
        get: function () {
...
var ControlChar = /** @class */ (function (_super) {
    __extends(ControlChar, _super);
    function ControlChar(charCode, charType, glyph, escapeCode, desciption, abbreviation) {
        var _this = _super.call(this, charCode, charType, glyph, escapeCode, desciption) || this;
        _this.abbreviation = abbreviation;
        _this.glyph = desciption;
        return _this;
    }
    return ControlChar;
}(PrintableChar));
...
(function () {
    ...
    gtag('js', new Date());
    gtag('config', 'UA-120559333-1');
})();
var PrintableChar = /** @class */ (function () {
